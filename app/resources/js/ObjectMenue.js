...
var top, left, obj, _clipboard, colorMenue = ConfigUI.COLORMENUEOBJ, selectedColor;
...
function changeColor(canvas, obj, position){
	...
	//console.log(obj.stroke);
		...
		obj.forEach(element => {
			if (element.fill !== "transparent" && element.fill !== "#EEEEEE" && element.fill !== null){
...
class ObjectMenue{
	...
	showColorMenue(canvas){
		...
		ConfigUI.COLORBUTTONOBJ1.addEventListener("click", function(){changeColor(canvas, obj, 1);});
		ConfigUI.COLORBUTTONOBJ2.addEventListener("click", function(){changeColor(canvas, obj, 2);});
		ConfigUI.COLORBUTTONOBJ3.addEventListener("click", function(){changeColor(canvas, obj, 3);});
		ConfigUI.COLORBUTTONOBJ4.addEventListener("click", function(){changeColor(canvas, obj, 4);});
		ConfigUI.COLORBUTTONOBJ5.addEventListener("click", function(){changeColor(canvas, obj, 5);});
		ConfigUI.COLORBUTTONOBJ6.addEventListener("click", function(){changeColor(canvas, obj, 6);});
		ConfigUI.COLORBUTTONOBJ7.addEventListener("click", function(){changeColor(canvas, obj, 7);});
		ConfigUI.COLORBUTTONOBJ8.addEventListener("click", function(){changeColor(canvas, obj, 8);});
		ConfigUI.COLORBUTTONOBJ9.addEventListener("click", function(){changeColor(canvas, obj, 9);});
		ConfigUI.COLORBUTTONOBJ10.addEventListener("click", function(){changeColor(canvas, obj, 10);});
	}
